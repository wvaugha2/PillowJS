const { isArrayOfStr, queryStringParser } = require('./util');
...
class HttpParams {
  ...
  constructor(params=undefined) {
    ...
    // If params was passed in as a string, attempt to parse it into an object
    if (params && typeof params === 'string') {
      params = queryStringParser(params);
    }

    // Store all params provided
